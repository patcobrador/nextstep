...
export type ProcessedEventWhereInput = {
  ...
  consumerKey?: Prisma.StringFilter<"ProcessedEvent"> | string
...
export type ProcessedEventWhereUniqueInput = Prisma.AtLeast<{
  consumerKey_eventId?: Prisma.ProcessedEventConsumerKeyEventIdCompoundUniqueInput
  AND?: Prisma.ProcessedEventWhereInput | Prisma.ProcessedEventWhereInput[]
  OR?: Prisma.ProcessedEventWhereInput[]
  NOT?: Prisma.ProcessedEventWhereInput | Prisma.ProcessedEventWhereInput[]
  consumerKey?: Prisma.StringFilter<"ProcessedEvent"> | string
...
export type ProcessedEventScalarWhereWithAggregatesInput = {
  ...
  consumerKey?: Prisma.StringWithAggregatesFilter<"ProcessedEvent"> | string
...
export type ProcessedEventConsumerKeyEventIdCompoundUniqueInput = {
  consumerKey: string
  eventId: string
}
...
export type ProcessedEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"consumerKey" | "eventId" | "processedAt", ExtArgs["result"]["processedEvent"]>
...
export interface ProcessedEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `consumerKey`
   * const processedEventWithConsumerKeyOnly = await prisma.processedEvent.findMany({ select: { consumerKey: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProcessedEvents and only return the `consumerKey`
   * const processedEventWithConsumerKeyOnly = await prisma.processedEvent.createManyAndReturn({
   *   select: { consumerKey: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more ProcessedEvents and only return the `consumerKey`
   * const processedEventWithConsumerKeyOnly = await prisma.processedEvent.updateManyAndReturn({
   *   select: { consumerKey: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProcessedEventFieldRefs {
  readonly consumerKey: Prisma.FieldRef<"ProcessedEvent", 'String'>
