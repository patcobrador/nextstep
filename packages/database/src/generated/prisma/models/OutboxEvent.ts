...
export type OutboxEventWhereInput = {
  ...
  actorId?: Prisma.UuidFilter<"OutboxEvent"> | string
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  actorId?: Prisma.UuidWithAggregatesFilter<"OutboxEvent"> | string
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "eventType" | "eventVersion" | "aggregateType" | "aggregateId" | "actorId" | "correlationId" | "causationId" | "payload" | "status" | "attempts" | "occurredAt" | "publishedAt" | "lastErrorCode", ExtArgs["result"]["outboxEvent"]>
